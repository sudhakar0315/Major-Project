...
<head>
<title>all movie news page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="title">All Movie News </h2>
          <p class="title">&nbsp;</p>
         <table width="565" border="1" >
                ...
                <tr>
                  <td  width="161" valign="middle" height="30" style="color: #666666;"><div align="left" class="style12 style8 style14 style13 style3" style="margin-left:20px;"><strong>MovieNews Name </strong></div></td>
                  <td  width="74" valign="middle" height="30"><div align="left" class="style11" style="margin-left:20px;">
                      <%out.println(s2);%>
                  </div></td>
                </tr>
