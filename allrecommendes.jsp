...
<head>
<title>all recommended movies</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="title">All Recommended Movie News </h2>
          <p class="title">&nbsp;</p>
         <table width="565" border="1" >
					...
					String s1,s2,s3,s4,s5,s6;
						int i=0;
					try{
					String sql1="select distinct(m_name) from recommends";
					Statement st1=connection.createStatement();
					ResultSet rs1=st1.executeQuery(sql1);
					while(rs1.next()){
					String mname=rs1.getString(1);
							String sql="select * from movies where name='"+mname+"'";
