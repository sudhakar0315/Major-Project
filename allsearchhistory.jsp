    ...
    <div class="content_resize">
      <div class="mainbar">
		...
		<%String user=(String)application.getAttribute("user");%>
		 <h2 class="style9">Users Search History </h2>
          <div class="clr"></div>
		      <div align="left"></div>
		      <div align="left"></div>
		  ...
		  <table width="552" border="1.0">
                        <tr>
						 <td width="100"><span class="style8">Username</span></td>
                          <td width="100"><span class="style8">Keyword</span></td>
                          <td width="150"><span class="style8">Date &amp; Time</span> </td>
                        </tr>
			  <%
		try 
	{
