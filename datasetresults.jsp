...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
				 <h2 class="style9">Complete And In-Complete Results   </h2>
          <div class="clr"></div>
		      <div align="left"></div>
		      <div align="left"></div>
		  ...
		  <table width="552" border="1.0">
                        <tr>
						 <td width="100" align="center" valign="middle"><span class="style8">Keyword</span></td>
                          <td width="100" align="center" valign="middle"><span class="style8">Complete</span></td>
                          <td width="100" align="center" valign="middle"><span class="style8">Incomplete</span></td>
                        </tr>
			  <%
		try 
	{
...
%>
                        ...
                        <tr>
               <td width="100" align="center" valign="middle"><%out.print(s1);%></td>
               <td width="100" align="center" valign="middle"><a href="completedataset.jsp?dt=<%=s4%>"><%out.print(s2);%></a></td>
               <td width="150" align="center" valign="middle"><a href="incompletedataset.jsp?dt=<%=s4%>"><%out.print(s3);%></a></td>
                        </tr>
