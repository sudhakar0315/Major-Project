    ...
    <div class="content_resize">
      <div class="mainbar">
		...
		<%String user=(String)application.getAttribute("user");%>
		 <h2><%=user%> Your Search History: </h2>
          <div class="clr"></div>
		      <div align="left"></div>
		      <div align="left"></div>
		  ...
		  <table width="552">
                        <tr>
                          <td width="153">Keyword</td>
                          <td width="166">Movie News Name</td>
                          <td width="217">Date &amp; Time </td>
                        </tr>
			  <%
		try 
	{
      		
           String query="select * FROM search_history where username='"+user+"'"; 
...
%>
                        ...
                        <tr>
                          <td width="153"><%out.print(s1);%></td>
                          <td width="166"><%out.print(s2);%></td>
                          <td width="217"><%out.print(s3);%></td>
                        </tr>
