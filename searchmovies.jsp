    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  <p>&nbsp;</p>
		  <form id="form1" name="form1" method="post" action="searchmovieresults.jsp">
		  <table width="517">
            <tr>
              <td width="215">Enter Movie News Name or Type </td>
                <td><label><input type="text" name="keyword" /> </label></td>
