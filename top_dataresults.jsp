    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  <p class="style3"> Top Movie News </p>
		 
		  <table width="500" border="1.0">
                  <tr>
                    <td width="161"><span class="style2 style4">Category</span></td>
                    <td width="158"><span class="style7">Movie Name</span></td>
                    <td width="164"><span class="style7">Score</span></td>
                  </tr>
...
<%
   	try 
	{
		...
		application.setAttribute("k",k);	
		String user=(String)application.getAttribute("user");
	
            	  String q2="select category,name,score from movies order by score desc  LIMIT 0,"+k+" "; 
    	...
    	String	s3=rs8.getString(3);
       	...
       	%>
                  <tr>
                    <td><%out.print(s1);%></td>
                    <td><a href="viewmovie.jsp?mname=<%=s2%>"><%out.print(s2);%></a></td>
                    <td><%out.print(s3);%></td>
                  </tr>
...
%>
		     <p align="right" class="style2"><a href="topkdata.jsp">Back</a></p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu"><li><a href="usermain.jsp">Home</a></li>
