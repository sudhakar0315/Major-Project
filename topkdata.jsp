    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  <p class="style3">Search Top Movie News </p>
		  <p class="style3">&nbsp;</p>
		  <form id="form1" name="form1" method="post" action="top_dataresults.jsp">
		  <table width="517">
            <tr>
              <td width="215">Enter 'K' Value </td>
                <td><label><input type="text" name="k" /> </label></td>
