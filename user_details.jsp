...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
					...
					<tr>
					<tr>
					  <td  width="127" valign="middle" height="50" style="color: #2c83b0;"><div align="left" class="style3 style4 style14 style7 style8" style="margin-left:20px;">Name</div></td>
					  ...
					  <td  width="127" valign="middle" height="48" style="color: #2c83b0;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">E-Mail</div></td>
					...
					<tr>
					  <td  width="127" valign="middle" height="51" style="color: #2c83b0;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">Mobile</div></td>
					  <td  width="182" valign="middle" height="51"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s3);%></div></td>
					</tr>
					<tr>
<td  width="127" align="left" valign="middle" height="46" style="color: #2c83b0;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">Date Of Birth</div> </td>                    	
<td  width="182" align="left" valign="middle" height="46"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s4);%></div></td>
					...
					<tr>
					  <td  width="127" align="left" valign="middle" height="59" style="color: #2c83b0;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">Address</div></td>
