...
<div class="main">
  ...
  <div class="content">
		...
		try 
	{
           ...
           String query="select * FROM recommends where r_to='"+user+"'"; 
           Statement st=connection.createStatement();
           ResultSet rs=st.executeQuery(query);
		  
		   %> <table width="552" border="1.0">
                        <tr>
                          <td width="100"><span class="style7">Recommended By</span></td>
                          <td width="100"><span class="style7">Movie News Name</span></td>
                          <td width="150"><span class="style7">Date &amp; Time</span> </td>
						   <td width="150"><span class="style7">Details</span> </td>
                        </tr><%
...
%>
                        ...
                        <tr>
						  ...
						  <td width="150"><a href="viewmoviedetails.jsp?mname=<%=s2%>">View Details</a></td>
                        </tr>
